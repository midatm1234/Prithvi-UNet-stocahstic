#!/usr/bin/env python
"""Python version of ALPS_downscaling_inference_T2_CNRM-CM5_static.ipynb.
...
INFERENCE_OUTPUT_ROOTS = ["/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/historical/perfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/historical/perfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/historical/imperfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/historical/imperfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/mid-century/perfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/mid-century/perfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/mid-century/imperfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/mid-century/imperfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/end-century/perfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/end-century/perfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/end-century/imperfect/",
        "/mnt/data2/kyo/granite-wxc/examples/CORDEX_ML/runs_v5/ALPS_T2_CNRM-CM5_static_train/predictions/end-century/imperfect/"
]
...
RUNS_ROOT = PROJECT_DIR / "runs_v5/ALPS_T2_CNRM-CM5_static_train"
CONFIG_PATH = PROJECT_DIR / "ALPS_T2_CNRM-CM5_static_v5.yaml"

TRAIN_SPLIT = "train/Emulator_hist_future"
TARGET_TEMPLATE_FILE = "pr_tasmax_CNRM-CM5_1961-1980_2080-2099.nc"
TRAIN_TARGETS = [DATASET_ROOT / TRAIN_SPLIT / "target" / TARGET_TEMPLATE_FILE]

FINETUNE_RUN_NAME = "ALPS_T2_CNRM-CM5_static"  # set None to auto-pick latest
USE_STATIC = True
