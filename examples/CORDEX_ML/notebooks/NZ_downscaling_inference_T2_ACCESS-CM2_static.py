...
INFERENCE_OUTPUT_ROOTS = [
    str(PROJECT_DIR / "runs/NZ_T2_ACCESS-CM2_static_train/predictions/historical/perfect/"),
    str(PROJECT_DIR / "runs/NZ_T2_ACCESS-CM2_static_train/predictions/historical/imperfect/"),
    str(PROJECT_DIR / "runs/NZ_T2_ACCESS-CM2_static_train/predictions/mid-century/perfect/"),
    str(PROJECT_DIR / "runs/NZ_T2_ACCESS-CM2_static_train/predictions/mid-century/imperfect/"),
    str(PROJECT_DIR / "runs/NZ_T2_ACCESS-CM2_static_train/predictions/end-century/perfect/"),
    str(PROJECT_DIR / "runs/NZ_T2_ACCESS-CM2_static_train/predictions/end-century/imperfect/"),
]
