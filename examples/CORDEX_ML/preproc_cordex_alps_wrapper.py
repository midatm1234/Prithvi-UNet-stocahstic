#!/usr/bin/env python
"""ALPS-domain wrapper to run preproc_cordex.py for multiple predictor/output sets.
...
preproc_cordex.py invocation per pair. Paths are relative to ALPS_TEST_ROOT.
"""
...
ALPS_TEST_ROOT = "/mnt/data2/kyo/granite-wxc/granite-geospatial-wxc-downscaling/CORDEX/ALPS_domain/"

# Use paths relative to ALPS_TEST_ROOT to keep the lists compact.
...
FILE_NAMES = [
        "CNRM-CM5_1981-2000.nc","MPI-ESM-LR_1981-2000.nc",
        "CNRM-CM5_1981-2000.nc","MPI-ESM-LR_1981-2000.nc",
        "CNRM-CM5_2041-2060.nc","MPI-ESM-LR_2041-2060.nc",
        "CNRM-CM5_2041-2060.nc","MPI-ESM-LR_2041-2060.nc",
        "CNRM-CM5_2080-2099.nc","MPI-ESM-LR_2080-2099.nc",
        "CNRM-CM5_2080-2099.nc","MPI-ESM-LR_2080-2099.nc"
]
TARGET_SAMPLE = (
    "/mnt/data2/kyo/granite-wxc/granite-geospatial-wxc-downscaling/CORDEX/ALPS_domain/"
    "train/ESD_pseudo_reality/target/pr_tasmax_CNRM-CM5_1961-1980.nc"
)
OROGRAPHY_FILE = (
    "/mnt/data2/kyo/granite-wxc/granite-geospatial-wxc-downscaling/CORDEX/ALPS_domain/"
...
def _run_preproc(predictor_files: list[str], output_dir: str) -> None:
    ...
    predictor_files = [str(Path(ALPS_TEST_ROOT) / p) for p in predictor_files]
    output_dir = str(Path(ALPS_TEST_ROOT) / output_dir)
