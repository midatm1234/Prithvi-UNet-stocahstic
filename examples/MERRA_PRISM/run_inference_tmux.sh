#!/usr/bin/env bash
#
# Run the MERRA-PRISM inference notebook headless in a detached tmux session,
...
NOTEBOOK="${REPO_ROOT}/examples/MERRA_PRISM/notebooks/merra_prism_inference.ipynb"
LOG_DIR="${REPO_ROOT}/examples/MERRA_PRISM/logs"
